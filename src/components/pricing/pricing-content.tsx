...
export function PricingContent({ user }: Props) {
  ...
  return (
    <main className="flex-1">
      <section className="bg-gray-100 border-b border-gray-200 py-12 lg:py-16 xl:py-20">
        <div className="mx-auto max-w-7xl 2xl:max-w-[1400px] px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-3xl sm:text-4xl lg:text-4xl xl:text-5xl font-bold text-gray-900 mb-4">{t.pricing.title}</h1>
      ...
      <section className="py-12 lg:py-16 xl:py-20 bg-white">
        <div className="mx-auto max-w-7xl 2xl:max-w-[1400px] px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-5 xl:gap-8 items-start">
            {PLANS.map(plan => (
              <div
                key={plan.key}
                className={`rounded-2xl border p-6 lg:p-5 xl:p-8 relative ${
                  plan.highlighted
